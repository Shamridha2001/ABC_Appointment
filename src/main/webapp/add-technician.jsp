  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="margin:0 50px;">
      <div class="navbar-nav" style="#ffff">
        ...
        <a class="nav-link active mx-0 mx-md-3 fw-bold fs-7 mt-3" href="Technician.jsp">Manage Technician</a>
...
<div class="container-fluid">
  ...
  <li class="nav-item">
    <a class="bg-primary text-white fw-bold fs-7 mt-3 nav-link " href="search-update-technician.jsp">SEARCH & UPDATE</a>
  </li>
  <li class="nav-item">
    <a class="bg-dark text-white fw-bold fs-7 mt-3 nav-link active" href="add-technician.jsp">ADD</a>
  </li>
  <li class="nav-item">
  </li>
</ul>
		...
		<div class="container">
			  <h3> <center><b> ADD TECHNICIAN</b> </center></h3>
			<br/>
