...
<nav class="navbar navbar-expand-lg navbar-light bg-info border border-primary " >
  ...
  <li class="nav-item">
    <a class="bg-dark text-white fw-bold fs-7 mt-3 nav-link active" href="Doctor">VIEW</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    ...
    <p>${message}</p>
    <br/>
    <div class="container form-group p-5 mx-auto mb-2 bg-light border border-primary border-4" style="max-width: 1100px;">
