...
<div class="container-fluid">
       <ul class="nav nav-tabs mt-4 px-10  bg-primary pt-10">
        <li class="nav-item">
            <a class="bg-primary text-white fw-bold fs-7 mt-3 nav-link " href="Patient.jsp">VIEW</a>
        </li>
        <li class="nav-item">
            <a class="bg-primary text-white fw-bold fs-7 mt-3 nav-link " href="search-update-patient.jsp">SEARCH & UPDATE</a>
        </li>
        <li class="nav-item">
            <a class="bg-dark text-white fw-bold fs-7 mt-3 nav-link active" href="add-patient.jsp">ADD</a>
        </li>
   </ul>
		<br/>
		<br/>
		...
		<div class="container">
			  <h3> <center><b> ADD PATIENT</b> </center></h3>
			<br/>
            <form method="post" action="patientController">
                ...
                <br/>
                <label for="medicalProblems"><b>Medical Problems:</b></label>
