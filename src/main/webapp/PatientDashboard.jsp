...
<style>
    body {
        ...
        background-margin: 100px 10px 0 50px ;
  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="margin:0 50px;">
      <div class="navbar-nav" style="#ffff">
        ...
        <a class="nav-link  mx-0 mx-md-3 fw-bold fs-7 mt-3" aria-current="page" href="PatientAppointment.jsp">Make Appointment</a>
         <a class="nav-link  mx-0 mx-md-3 fw-bold fs-7 mt-3" aria-current="page" href="add-payment.jsp">Make Payment</a>
