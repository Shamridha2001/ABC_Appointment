  ...
  <div class="container-fluid" >
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="margin:0 50px;">
      <div class="navbar-nav" style="#ffff">
        ...
        <a class="nav-link mx-0 mx-md-3  fs-6" href="search-and-update-patient.jsp">View Patient</a>
        <a class="nav-link mx-0 mx-md-3 fs-6" href="Technician.jsp">Manage Testresult</a>
        <a class="nav-link mx-0 mx-md-3 fs-6" href="Appointment.jsp">View Appointment</a>
